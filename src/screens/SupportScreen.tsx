...
const FAQS = [
  {
    ...
    a: 'Зарегистрируйся на 1xBet через раздел "Ставки" и внеси первый депозит от 5000 тнг (≈ €9,5). Это твой личный банк — деньги остаются твоими. После подтверждения активируем PRO в течение 24 часов.',
  },
  {
  ...
  },
  {
    ...
    a: 'Убедись что ввёл правильный ID аккаунта 1xBet при подаче заявки. Активация до 24 часов. Если прошло больше — напиши в живой чат, разберёмся быстро.',
  },
  {
    q: 'Можно ли вывести депозит с 1xBet?',
