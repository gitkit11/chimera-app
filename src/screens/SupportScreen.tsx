...
const FAQS = [
  {
    ...
    a: 'Зарегистрируйся на 1xBet через раздел "Ставки" и внеси первый депозит от 5000 тнг. Это твой личный банк — деньги остаются твоими. После подтверждения активируем PRO в течение 24 часов.',
  },
  {
