...
const FAQS = [
  {
    ...
    a: 'Зарегистрируйся на 1xBet через раздел "Ставки" и внеси первый депозит от 3 000 ₸. Это твой личный банк — деньги остаются твоими. После подтверждения активируем PRO в течение 24 часов.',
  },
  {
